            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-border/60 pb-4">
              <div>
                ...
                <p className="mt-0.5 text-xs text-muted-foreground">
                  {user ? "Signed in with Google" : "Sign in required to submit message"}
                </p>
              </div>
              ...
              {user ? (
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl border border-border bg-background px-3 py-1.5 text-xs font-bold text-ink shadow-sm hover:border-primary transition-colors"
                >
