              ...
              {user ? (
                ...
                <div className="space-y-2 pt-2">
                  <Link
                    ...
                    className="inline-flex h-12 w-full items-center justify-center gap-2.5 rounded-full bg-white border border-border px-6 text-sm font-bold text-ink shadow-sm transition-all hover:bg-gray-50 hover:shadow"
                  >
            ...
            <div className="rounded-3xl border border-border bg-surface p-6 sm:p-8">
              ...
              <ul className="mt-5 grid gap-4 text-sm text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  {companySettings?.address || "Kamalpokhari, Kathmandu, Nepal"}
                </li>
