  ...
  return (
    <section className="hero-wash border-b border-border">
      <div className="container-page py-12 sm:py-24">
        ...
        <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground sm:mt-5 sm:text-lg">{subtitle}</p>
...
export function SectionHeading({
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h2 className="mt-2.5 font-display text-2xl font-extrabold text-ink sm:mt-3 sm:text-4xl">{title}</h2>
      {subtitle ? <p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:mt-4 sm:text-base">{subtitle}</p> : null}
    </div>
  );
}
  ...
  return (
    <section className="container-page py-12 sm:py-20">
      <div className="hero-wash relative overflow-hidden rounded-2xl border border-border bg-surface px-5 py-10 text-center shadow-soft sm:rounded-3xl sm:px-14 sm:py-14">
        <div className="contour pointer-events-none absolute inset-x-0 bottom-0 h-40 opacity-40" aria-hidden="true" />
        <div className="relative">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-muted-foreground sm:mt-4 sm:text-base">
            Tell us about your product, your timeline and your ambition. We'll bring the engineering.
          </p>
